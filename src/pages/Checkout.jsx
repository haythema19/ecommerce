              ...
              >
                ...
                <div className="flex-grow-1">
                  <div className="form-floating mb-3">
                    ...
                    />
                    <label htmlFor="firstName">First name (option)</label>
                  </div>
                </div>
                <div className="flex-grow-1">
                  <div className="form-floating mb-3">
          ...
          <div className="col-5">
            <div className="d-flex align-items-center justify-content-between border-bottom py-4">
              <div className="w-75 d-flex align-items-center gap-20">
                ...
                <div>
                  <h5 className="title total">Product</h5>
                  <p className="mb-0 total-price">S / Blue</p>
                </div>
              </div>
